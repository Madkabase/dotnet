...
public class DeviceBo
{
    ...
    public DeviceBo(string devEUI, string name, string joinEUI, string appKey, /*FieldBo field,*/ ICollection<DeviceDataBo> deviceData, Point location)
    {
        DevEUI = devEUI;
        Name = name;
        JoinEUI = joinEUI;
    ...
    {
        return new DeviceBo(device.Id, device.Name, "", "", /*new FieldBo(),*/ device.Data.Select(d => DeviceDataBo.FromDto(d)).ToList(), new Point(0, 0));
    }
}